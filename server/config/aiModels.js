/**
 * Catálogo Canónico Centralizado de Proveedores y Modelos de Inteligencia Artificial (LLMs)
 * wagent-crm — República de la Carne & CRM Multi-Agente
 */
...
export const isSystemSupportedProvider = (providerId) => {
  return SYSTEM_AI_PROVIDERS.some(p => p.id === providerId);
};

export const isSystemSupportedModel = (providerId, modelId) => {
